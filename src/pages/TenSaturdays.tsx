...
*/}
      {/* CTA */}
      <section id="apply" className="py-20 bg-gradient-to-b from-orange-50 to-amber-50 relative ">
        <div className="bg-card rounded-2xl border p-8 md:p-12 text-center mx-auto max-w-6xl px-4 py-16 ">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">Ready to apply?</h2>
          <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
            Submit your details and we’ll follow up with the next steps and available start dates.
          </p>
