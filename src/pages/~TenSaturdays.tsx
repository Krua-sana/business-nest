...
export default function TenSaturdays() {
              ...
              <div className="mx-auto max-w-6xl px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
                <div>
                  ...
                  <p className="mt-4 text-lg text-muted-foreground">
                    Turn Your Expertise Into Your Next Career Move.
                  </p>
                  <p className="mt-2 text-muted-foreground">
                    A practical program for tech professionals and specialists in transition — whether after a layoff or alongside your current job.
                    <br/><br/>Learn how to transform your domain knowledge into a validated business with structure, mentorship, and a community that accelerates your success.
                  </p>
